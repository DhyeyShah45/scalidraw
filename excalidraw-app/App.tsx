...
const ExcalidrawWrapper = () => {
  ...
  /*
   * Every way IN to collaboration is gone from this build — the share button,
   * the menu item, the welcome-screen entry and the command-palette commands.
   * It is a hosted-Excalidraw feature needing Firebase and a websocket server,
   * and this instance is single-user by design.
   *
   * The machinery itself still mounts. Ripping it out would mean unpicking it
   * from the scene bootstrap, which is shared with the normal load path, and
   * would make every upstream merge painful for no gain — with no UI to reach
   * it, it simply never runs.
   */
      ...
      >
        ...
        <CommandPalette
          customCommandPaletteItems={[
            /*
              Only this one survives. The rest were live collaboration, share,
              and links out to GitHub / X / Discord / YouTube / Excalidraw+ —
              each either navigates away from your canvas or advertises the
              hosted product this instance replaces.
            */
            {
